...
What testers do is provide information. We're instruments. We help the people building the product see things they can't see on their own — the edge cases, the assumptions that don't hold, the behavior nobody designed for. We're extra eyes, extra hands, extra paranoia. Jerry Weinberg put it perfectly: "You're in quality assurance? Are you allowed to change the source code? No? Then how can you assure quality?"

I've known Michael Bolton for years. I once argued with Cem Kaner — and if you know Cem, you know that's a credential, not a complaint. I've met James Bach many times, learned from Jerry Weinberg in person. These are the people who shaped how I think about testing. The context-driven school. Testing is a human activity. It requires skill, judgment, and critical thinking. It's not a phase in a process. It's not something you automate away. Automation is a tool that helps testers do their work. The thinking is the work.
...
I grew up in fast food. Taco Bell, then managing a Subway at 19. What those years taught me about teamwork, pressure, and showing up when things go wrong has been more useful than any computer science class I've taken. When you're running a lunch rush with a broken fryer and a no-show, you learn to prioritize, adapt, and not panic. Every leadership instinct I have traces back to a kitchen.

I taught myself the MCSE on Windows NT4 because I wanted to understand how computers actually worked. Not the theory — the guts. The registry, the network stack, the permissions model. I built a homelab before the word existed. That lab has never stopped growing. It's currently a fleet of Macs, a GPU server with six RTX 3090s, and more automation than most startups.

My first real tech job was at Winternals, working alongside Mark Russinovich before Microsoft acquired the company. I found a $300K revenue bug by testing the way a real user would use the product — not by following a test case, but by thinking about what could go wrong. That moment taught me the value of a tester who actually thinks.

## The automation journey

At HomeAway, I inherited manual testing on the vacation rental platform that would eventually become Vrbo and get acquired by Expedia for $3.9 billion. I started as a Senior QA Engineer — that was the title, and that was the era. Click through flows, file bugs, repeat.

I saw what automation could do and started building. Selenium at first, then WebDriver, then frameworks that other teams could use. The work evolved from "write test scripts" to "build testing infrastructure." The team grew. I went from individual contributor to managing 62 people across 5 teams.
